...
public class ProductController {
    ...
    return List.of(
            ...
            new Product("Nowy produkt 3", "Nowa kategoria 3", "Nowy opis 3", new BigDecimal(9.99), "PLN"),
            new Product("Nowy produkt 4", "Nowa kategoria 4", "Nowy opis 4", new BigDecimal(9.99), "PLN")
    );
    }
}
